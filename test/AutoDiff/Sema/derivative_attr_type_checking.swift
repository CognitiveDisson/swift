// RUN: %target-swift-frontend-typecheck -verify -verify-ignore-unrelated -target %target-swift-5.1-abi-triple %s -package-name myPkg -enable-experimental-feature BorrowAndMutateAccessors -enable-experimental-feature CoroutineAccessors -enable-experimental-feature CoroutineFunctions
// RUN: %target-swift-frontend-typecheck -enable-testing -verify -verify-ignore-unrelated -target %target-swift-5.1-abi-triple %s -package-name myPkg -enable-experimental-feature BorrowAndMutateAccessors -enable-experimental-feature CoroutineAccessors -enable-experimental-feature CoroutineFunctions
